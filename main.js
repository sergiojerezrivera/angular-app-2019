...
module.exports = "<header>\n  \n  <ul>\n    <li><a [routerLink]=\"['/sobre-mi']\" [routerLinkActive]=\"['actived']\">About me</a></li>\n    <li><a [routerLink]=\"['/proyectos']\" [routerLinkActive]=\"['actived']\">Projects</a></li>\n    <li id=\"logo\"><a target=\"blank\" href=\"https://github.com/sergiojerezrivera\">SR</a></li>\n    <li><a [routerLink]=\"['/crear-proyecto']\" [routerLinkActive]=\"['actived']\">Create Projects</a></li>\n    <li><a [routerLink]=\"['/contacto']\" [routerLinkActive]=\"['actived']\">Slider</a></li>\n  </ul>\n\n  \n</header>\n\n\n<section id=\"content\">\n\n  <router-outlet></router-outlet>\n\n</section>\n\n\n<footer>\n\n   Sergio Jerez Rivera 2019 &copy;\n\n</footer>\n\n"
...
module.exports = "<div id=\"title\">\n  <h1>{{title}}</h1>\n  <h2>{{subtitle}}</h2>\n  <p><a target=\"blank\" href=\"{{web}}\">Link to my Github projects</a></p>\n</div>\n\n<article class=\"about\">\n  <h2>About this project</h2>\n  <p>This is a webApp built with Angular 7 for the front end, not fully responsive, and most foccused on learning the functionality between components, services, HTTP requests, libraries and backend using NodeJs express.\n  The purpose of this webApp is to create projects/products with their information and display them in a organised way to be able to add, edit or remove them at anytime with just a few clicks, all the functionality is instantly with no refreshing of the app, similar to a control panel functionality. </p>\n</article>"
...
module.exports = "<div class=\"container\">\n  <h4>Insert a number and press \"enter\" key or \"Load Slider\" button to show a slider width customised size in pixels</h4><br>\n\n  <input type=\"number\" [(ngModel)]=\"widthSlider\" placeholder=\"insert width value\" autofocus (keyup.enter)=\"cargarslider()\">\n  <button (click)=\"cargarslider()\">Load Slider</button>\n  <button (click)=\"resetearSlider()\">Reset Slider</button>\n    <div *ngIf=\"anchuraToSlider\">\n      <slider [anchura]=\"anchuraToSlider\"\n              [etiquetas]=\"captions\"\n              (conseguirAutor)=\"getAutor($event)\"\n      ></slider>\n  </div>\n\n  <div *ngIf=\"autor\">\n    {{autor.nombre}}\n  </div>\n\n</div>\n\n"
...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.cargarslider = function () {
        this.anchuraToSlider = this.widthSlider;
    };
    ContactComponent.prototype.resetearSlider = function () {
        this.anchuraToSlider = null;
        this.autor = null;
        this.widthSlider = null;
    };
    ContactComponent.prototype.getAutor = function (event) {
        //console.log(event);
        this.autor = event;
    };
...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(_projectService, _uploadService) {
        ...
        this.project = new _models_project__WEBPACK_IMPORTED_MODULE_2__["Project"]('', '', '', '', 2019, '', '');
    }
        ...
        this._projectService.saveProject(this.project).subscribe(function (response) {
            if (response.project) {
                ...
                if (_this.filesToUpload) {
                    _this._uploadService.makeFileRequest(_services_global__WEBPACK_IMPORTED_MODULE_5__["Global"].url + "upload-image/" + response.project._id, [], _this.filesToUpload, 'image').then(function (result) {
    ...
    CreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_project_service__WEBPACK_IMPORTED_MODULE_3__["ProjectService"],
...
var DetailComponent = /** @class */ (function () {
    ...
    DetailComponent.prototype.setConfirm = function (confirm) {
...
var EditComponent = /** @class */ (function () {
    function EditComponent(_projectService, _uploadService, _route, _router) {
        this._projectService = _projectService;
        this._uploadService = _uploadService;
        this._route = _route;
        this._router = _router;
    ...
    EditComponent.prototype.onSubmit = function () {
        ...
        this._projectService.updateProject(this.project).subscribe(function (response) {
            if (response.project) {
                //Subir la imagen
                if (_this.filesToUpload) {
                    _this._uploadService.makeFileRequest(_services_global__WEBPACK_IMPORTED_MODULE_4__["Global"].url + "upload-image/" + response.project._id, [], _this.filesToUpload, 'image').then(function (result) {
                        //console.log(result);
                        _this.save_project = result.project;
                        _this.status = 'success';
                    });
...
module.exports = "\n<div class=\"container\">\n  <h2>Projects from MongoDB database</h2>\n  <h4>A list of projects consumed with Angular from NodeJs Backend.</h4><br>\n  <ul>\n    <li *ngFor=\"let project of projects\" class=\"project\">\n      <a [routerLink]=\"['/proyecto', project._id]\">\n      <div class=\"project-img\">\n      <div class=\"image\">\n        <img src=\"{{url+'get-image/'+project.image}}\" \n        *ngIf=\"project.image\"/> \n      </div>\n      </div>\n      <h3>{{project.name}}</h3>\n      <p>{{project.category}}</p>\n      </a>\n    </li>\n  </ul>\n</div>"
...
var SliderComponent = /** @class */ (function () {
    ...
    SliderComponent.prototype.lanzar = function (event) {
        //console.log(event);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])("etiquetas"),
...
module.exports = __webpack_require__(/*! C:\Users\USER\Desktop\proyecto-angular - Copy\src\main.ts */"./src/main.ts");
